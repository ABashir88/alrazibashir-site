  ...
  return (
    <div style={{ minHeight: "100vh", backgroundColor: "var(--color-bg)", color: "var(--color-text)" }}>
      ...
      <main style={{ maxWidth: "960px", margin: "0 auto", padding: "clamp(3rem, 6vw, 5rem) 1.5rem" }}>
        ...
        {/* CORE VALUE AREAS — editorial ruled rows */}
        ...
        <div style={{ marginBottom: "5rem" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(180px, 1fr))", gap: "0", borderTop: "1px solid var(--color-border)", borderLeft: "1px solid var(--color-border)" }}>
            {[
          ...
          <div style={{ display: "flex", flexWrap: "wrap", gap: "0.75rem", alignItems: "center", marginBottom: "1.5rem" }}>
            <Link href={siteConfig.resumeUrl} target="_blank"
              style={{
                ...
                fontWeight: 700, fontSize: "0.82rem", padding: "0.65rem 1.5rem",
            ...
            <Link href={`mailto:${siteConfig.email}`}
              style={{
                ...
                fontWeight: 600, fontSize: "0.82rem", padding: "0.65rem 1.5rem",
                borderRadius: "999px", fontFamily: "var(--font-body)", transition: "all 0.2s ease",
                textDecoration: "none"
              }}
